      ...
      <div className=" w-full h-full flex ">
        {data.map((book, index) => (
          <div
            ...
            className=" h-3/5 w-full flex  bg-white border-2 border-gray-200 rounded-lg shadow p-2 hover:scale-105 cursor-pointer "
          >
          ...
          <Modal.Body>
            {data.map((book, index) => (
              <div
                key={index}
                onClick={() => setOpenModal(true)}
                className=" h-3/5 w-full flex  bg-white border-2 border-gray-200 rounded-lg shadow p-2 hover:scale-105 hover:scale-100 "
              >
                <div className=" flex w-1/2 items-center pl-11">
                  <img
