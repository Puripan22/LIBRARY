...
function Book_table({ data, category }) {
  ...
  useEffect(()=>{
    console.log(`this is book table component selectradio = ${category}`)
          ...
          {filteredData.map((dataItem) => (
            ...
            >
              ...
              <td className="px-6 py-4">
                <div className=" flex">
                  <button
                    className="text-m p-2 border-solid border-2 border-gray-100 rounded bg-[#40d866] text-white hover:bg-[#49a761]
                    hover:scale-110"
                  >
                    <svg
